...
\Ex{6.1.4}
Define a family of sets $S_{ij}, ~i, j \in \N$ inductively as follows.
\begin{align*}
  S_{i,0} &= \{ 0, \dots, i - 1 \}, ~i \in \N, \\
  S_{ij} &= S_{i, j - 1}
         \cup \{ \lmd{} |t| \mid |t| \in S_{i + 1, j - 1} \}
         \cup \{ |t|_1 ~|t|_2 \mid |t|_1, |t|_2 \in S_{i, j - 1} \}, \\
         & \hspace{20em} i \in \N, j \in \N \setminus \{ 0 \}
\end{align*}
Then, define a family of sets
  $\mathcal S = \{\mathcal S_0, \mathcal S_1, \mathcal S_2, \dots \}$ by
  $\mathcal S_i = \bigcup_j S_{ij}, ~i \in \N$.
Each set $\mathcal S_i$ in this family coincides with $\mathcal T_i$.

\paragraph{Proof} \textbf{TODO...}
